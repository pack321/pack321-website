(function(){
  ...
  function render(host,index){
    ...
    host.innerHTML=host.hasAttribute('data-code-search-utility')?`<div class="find-scout-card"><div class="find-scout-privacy"><p class="eyebrow">Private fundraising access</p><h1>Privacy Comes First</h1><p>Pack 321 does not provide:</p><ul><li>Public Scout directory</li><li>Name search</li><li>Autocomplete</li><li>Scout suggestions</li></ul><p>Fundraising access is available only through a code shared directly by a Scout or family.</p></div><div class="find-scout-lookup"><h2>Support a Scout</h2><form class="code-search-form" data-code-search-form novalidate><div class="code-search-error" id="${summaryId}" data-code-search-error role="alert" tabindex="-1" hidden></div><div class="form-field"><label for="${inputId}">Fundraising code</label><div class="code-search-controls"><input id="${inputId}" name="fundraisingCode" type="text" inputmode="text" autocomplete="off" autocapitalize="characters" spellcheck="false" maxlength="12" placeholder="Enter code" aria-describedby="${helperId} ${resultId}"><button class="button gold" type="submit">Find Scout</button></div><p class="field-helper" id="${helperId}">Enter the fundraising code shared directly by the Scout or family.</p><p class="code-search-result" id="${resultId}" data-code-search-result aria-live="polite"></p></div></form><a class="button outline find-scout-fallback" href="/fundraising.html">Support Pack 321 generally</a></div></div>`:`<div class="wrap"><div class="code-search-card"><div class="code-search-copy"><p class="eyebrow">Private code lookup</p><h2>Support a Scout</h2><p>Use a fundraising code to open a guardian-approved public Scout page. No directory or name search is provided.</p></div><form class="code-search-form" data-code-search-form novalidate><div class="code-search-error" id="${summaryId}" data-code-search-error role="alert" tabindex="-1" hidden></div><div class="form-field"><label for="${inputId}">Fundraising code</label><div class="code-search-controls"><input id="${inputId}" name="fundraisingCode" type="text" inputmode="text" autocomplete="off" autocapitalize="characters" spellcheck="false" maxlength="12" placeholder="Enter code" aria-describedby="${helperId} ${resultId}"><button class="button gold" type="submit">Find Scout</button></div><p class="field-helper" id="${helperId}">Enter the code shared by the Scout or family.</p><p class="code-search-result" id="${resultId}" data-code-search-result aria-live="polite"></p></div></form></div></div>`;
